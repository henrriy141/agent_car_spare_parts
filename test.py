...
# Run a focused web-research summary for a single part.
def web_researcher_node():
    search_results = web_search("I need Alternator 130A Remanufactured")
    ...
    ### DATA
    INTERNAL DATA:The Alternator 130A Remanufactured is available. Its part number is ALT-130A and it costs 129.99. It is in stock.
